const DELIVERY_TIERS = [
  ...
  },
  {
    ...
    tier: 'local',
    etaHours: 8,
    note: 'May slip to next day after local cutoff',
  },
  {
    max: 500,
    label: '24 hours',
    tier: 'regional',
    etaHours: 24,
    note: 'Highway delays can add 4-6 hrs',
  },
  {
    max: Infinity,
    label: '3-4 days',
    tier: 'long-haul',
    etaHours: 96,
    note: 'Customs/remote-area surcharge possible',
  },
];

/**
 * Maps a distance in km to a delivery tier.
 * Boundaries are upper-inclusive: 15 -> hyperlocal, 45 -> local, 500 -> regional.
 */
